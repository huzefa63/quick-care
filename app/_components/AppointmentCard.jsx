...
function AppointmentCard({ setAppointmentId, appointment,setPosition,setIsContext, isContext, position }) {
  ...
  return (
    <div className="border- pr-6 pl-3 bg-gray-100 relative border-gray-300 min-h-[30%] rounded-2xl [box-shadow:0px_6px_12px_rgba(0,0,0,0.1),0px_-6px_12px_rgba(0,0,0,0.05)]">
